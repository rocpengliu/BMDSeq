...
class lognormalPOLYNOMIAL_BMD_NC : public lognormalLLModel {
 public:
  lognormalPOLYNOMIAL_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS, int degree)
      : lognormalLLModel(tY, tX, SS) {
    deg = degree;
  };

  lognormalPOLYNOMIAL_BMD_NC(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS, bool CV, int degree)
      : lognormalLLModel(tY, tX, SS) {
    deg = degree;
  };
  ...
  virtual cont_model mean_type() { return cont_model::polynomial; }
