...
printf("8888888888888888888888888888aaaaaaaaaaaaaaaaaaaaa\n");
  for (int i = 0; i < M->nParms(); i++) lb[i] = temp_data(i, 0);
  temp_data = M->parmUB();

  std::vector<double> ub(M->nParms());
printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb\n");
  for (int i = 0; i < M->nParms(); i++) ub[i] = temp_data(i, 0);
  printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb111111111111111111111111\n");
  std::vector<double> x(startV.rows());
  printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb222222222222222222222222222222\n");
  if (OPTIM_USE_GENETIC & flags) {
    bool op_size = (OPTIM_USE_BIG_GENETIC & flags);
    printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb333333333333333333333333333\n");
    try {
      x = startValue_F(M, startV, lb, ub, op_size);
printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb444444444444444444444444444\n");
    } catch (...) {
    }
  } else {
    printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb55555555555555555555555555555\n");
    for (int i = 0; i < x.size(); i++) {
      x[i] = startV(i, 0);
    }
    printf("8888888888888888888888888888bbbbbbbbbbbbbbbbbbbbbbbbbbb666666666666666666666\n");
  }
printf("8888888888888888888888888888ccccccccccccccccccccccccccccccccc\n");
  int yy = x.size();
...
printf("8888888888888888888888888888ddddddddddddddddddddddddddddddddddd\n");
  double minf;
  ...
  nlopt::opt *opt_ptr;
printf("8888888888888888888888888888eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee\n");
  int opt_iter;
...
printf("8888888888888888888888888888fffffffffffffffffffffffffffffffffffffffff\n");
    ...
    ///////////////////////////////////////////////
printf("8888888888888888888888888888gggggggggggggggggggggggggggggggggggggggggg\n");
    try {
...
printf("8888888888888888888888888888hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh\n");
  Eigen::Map<Eigen::MatrixXd> d(x.data(), M->nParms(), 1);
  oR.result = result;
  oR.functionV = minf;
  oR.max_parms = d;
  // cout << "Result Opt:" << result << "\n---\n"<< endl << d ;
printf("8888888888888888888888888888iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii\n");
  M->setEST(d);

  if (result < 0) {
    // cerr << __FUNCTION__ << " at line: " << __LINE__ << " result= " << result << endl;
  }
printf("8888888888888888888888888888jjjjjjjjjjjjjjjjjjjjjjjjjjjjjj\n");
  return oR;
}
