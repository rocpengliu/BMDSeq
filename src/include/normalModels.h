...
class normalLLModel : public normalLL {
 public:
  normalLLModel() {};
  normalLLModel(Eigen::MatrixXd tY, Eigen::MatrixXd tX, bool SS, bool CV)
      : normalLL(tY, tX, SS), constant_variance(CV) {
          // if it is a sufficient statistics model
        };

  cont_model mean_type() { return cont_model::generic; }
  ...
  bool isConstVar() { return constant_variance; }
  ...
  virtual double bmd_absolute(Eigen::MatrixXd theta, double BMRF, bool isIncreasing) {
    return 0.0;
  };
  ...
  virtual double bmd_hybrid_extra(
      Eigen::MatrixXd theta, double BMRF, bool isIncreasing, double BPROB
  ) {
    return 0.0;
  };

  // BASIC BMD Computation absolute to hybrid
  virtual double bmd_absolute_bound(
      Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
  ) {
    return 0.0;
  };
  virtual double bmd_stdev_bound(
      Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
  ) {
    return 0.0;
  };
  virtual double bmd_reldev_bound(
      Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
  ) {
    return 0.0;
  };
  virtual double bmd_point_bound(
      Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
  ) {
    return 0.0;
  };
  ;
  virtual double bmd_extra_bound(
      Eigen::MatrixXd theta, double BMD, double BMRF, bool isIncreasing
  ) {
    return 0.0;
  }
  virtual double bmd_hybrid_extra_bound(
  ...
  virtual double bmd_start_extra_hybrid(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  }
  ////////////////////////////////////////////////////////
  virtual double bmd_start_absolute(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  }

  virtual std::vector<double> bmd_start_absolute_clean(
  ...
  /////////////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////
  virtual double bmd_start_stddev(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  };

  virtual std::vector<double> bmd_start_stddev_clean(
      std::vector<double> x, double BMRF, double BMD, bool isIncreasing
  ) {
    return x;
  };
  ...
  virtual double bmd_start_reldev(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  };

  virtual std::vector<double> bmd_start_reldev_clean(
      std::vector<double> x, double BMRF, double BMD, bool isIncreasing
  ) {
    return x;
  };
  ...
  virtual double bmd_start_extra(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  };
  virtual std::vector<double> bmd_start_extra_clean(
      std::vector<double> x, double BMRF, double BMD, bool isIncreasing
  ) {
    return x;
  };
  ...
  //////////////////////////////////////////////////////
  /////////////////////////////////////////////////////////////////////////
  virtual double bmd_start_point(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  }

  virtual std::vector<double> bmd_start_point_clean(
      std::vector<double> x, double BMRF, double BMD, bool isIncreasing
  ) {
    return x;
  }
  ...
  virtual double bmd_start_hybrid_extra(unsigned n, const double *b, double *grad, void *data) {
    return 0.0;
  }
  std::vector<double> bmd_start_hybrid_extra_clean(
  ...
  //////////////////////////////////////////////////////
  //////////////////////////////////////////////////////
  Eigen::MatrixXd eqConst_gradient(
      Eigen::MatrixXd theta, contbmd type, double BMD, double BMRF, bool isIncreasing,
      double tail_prob
  );
  ////////////////////
  virtual double equality_boundG(
